...
RSpec.describe HtmlBeautifier do
  describe "behavior" do
    ...
    it "indents only the first line of code inside <script> or <style> and retains the other lines' indents relative to the first line" do # rubocop:disable Layout/LineLength
      source = code <<~HTML
        <script>
          function(f) {
              g();
